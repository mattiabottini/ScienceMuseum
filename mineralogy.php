<?php
  ...
  echo '<header id="header"><br> <img class = "headerImage" src="./logo.svg" alt="logo"><a class="header" href="./index.php">National Museum of Colorado</a></header>
            ...
            echo "<table>";
            echo "<tr> <td>Name</td> <td>Category</td> <td>Formula</td><td>Color</td><td>Hardness <br> (Mohs Scale)</td><td>Museum Section</td></tr>";
            while($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {
              echo "<tr><td>" . $row['name'] . "</td><td>" . $row['category'] . "</td><td>" . $row['formula'] . "</td><td>" . $row['color'] . "</td><td>" . $row['hardness'] . "</td><td>" . $row['museumSection'] . "</td></tr>";
            }
            echo "</table>";
            mysqli_close();
    echo  '</article>
