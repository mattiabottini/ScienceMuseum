...
<html lang="en">
      ...
      <body>
        ...
        <article class="content"> <h1> Zoology Section </h1>
          <h3>In our <em> Zoology Section </em> you can find: </h3> <br>
          <table>
            <tr class='tableDescription'> <td>Name</td> <td>Scientific Name</td> <td>Family</td><td>Color</td><td>Habitat</td><td>Conservation Status</td><td>Museum Section</td><td class='lastRow'>Image</td></tr>
            <?php
