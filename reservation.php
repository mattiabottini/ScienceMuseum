...
<?php
    ...
    $htmlAccepted='<article class="content"> 
                    <h1 class="reservationAccepted"> Your reservation has been accepted!</h1> 
    ...
    $htmlNotAccepted='<article class="content"> 
                        <h1 class="reservationRefused"> Your reservation can not be accepted: <br>NO AVAILABLE SEATS</h1> 
                        <img src="logos/logo.svg" alt="CNM logo" class="bigLogo"> 
                      </article>
                      <footer id="footer" class="bookFooter"> CNM &copy; Copyright 2022 - All rights reserved</footer>';

    $emailAlreadyUsed='<article class="content"> 
                        <h1 class="reservationRefused"> Your reservation can not be accepted: <br>EMAIL USED IN ANOTHER RESERVATION!</h1> 
                        <img src="logos/logo.svg" alt="CNM logo" class="bigLogo">
                       </article>
                       <footer id="footer" class="bookFooter"> CNM &copy; Copyright 2022 - All rights reserved</footer>';
